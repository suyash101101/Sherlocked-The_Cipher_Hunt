...
const islands = [
  { id: 1, name: "Baker Street", x: 5, y: 20 },
  { id: 2, name: "Scotland Yard", x: 20, y: 75 },
  { id: 3, name: "Reichenbach Falls", x: 45, y: 30 },
  { id: 4, name: "Baskerville Hall", x: 70, y: 85 },
  { id: 5, name: "221B", x: 80, y: 10 },
];
...
export default function Level() {
  ...
  return (
    <div className="sherlock-background bg-[url('https://static.vecteezy.com/system/resources/previews/036/105/309/non_2x/ai-generated-vintage-map-of-the-world-on-the-old-paper-background-sepia-tone-ai-generated-free-photo.jpg')] bg-no-repeat bg-cover bg-center object-cover relative h-[80em]">
